...
test("E4: ack remove o ref dos pendentes", () => {
...
test("E4: timeout dentro do orcamento gera retry", () => {
...
test("E4: timeout no limite do orcamento descarta", () => {
